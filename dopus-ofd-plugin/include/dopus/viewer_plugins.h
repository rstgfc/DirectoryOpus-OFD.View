/*
   ...
   说明：本文件为 GP Software 官方 Viewer Plugin SDK 头文件原文
   （接口版本 4，适用于 Directory Opus 9 ~ 13 的全部版本）。
   来源：GP Software SDK / IbDOpusExt (MIT) 仓库附带的官方头文件。
   请勿修改，以保证与 Directory Opus 的二进制接口完全一致。
*/
...
#define LPDVPCONTEXTMENUITEM	DVPCONTEXTMENUITEMW
#else
#define DVPCONTEXTMENUITEM		DVPCONTEXTMENUITEMA
#define LPDVPCONTEXTMENUITEM	DVPCONTEXTMENUITEMA
#endif
...
#define LPDVPLOADTEXTDATA	DVPLOADTEXTDATAW
#else
#define DVPLOADTEXTDATA		DVPLOADTEXTDATAA
#define LPDVPLOADTEXTDATA	DVPLOADTEXTDATAA
#endif
...
#define LPDVPFILEINFOMUSIC	DVPFILEINFOMUSICW
#else
#define DVPFILEINFOMUSIC	DVPFILEINFOMUSICA
#define LPDVPFILEINFOMUSIC	DVPFILEINFOMUSICA
#endif
...
#define LPDVPFILEINFOMOVIE	DVPFILEINFOMOVIEW
#else
#define DVPFILEINFOMOVIE	DVPFILEINFOMOVIEA
#define LPDVPFILEINFOMOVIE	DVPFILEINFOMOVIEA
#endif
